...
public class Break_Room_Lobby_Level_GUI {
    Break_Room_Lobby_Level_GUI(){
        // Window Frame
            JFrame frame = new JFrame("Break Room Lobby Level window");
        ...
        // Welcome to the Break Room Lobby Level section
            JLabel Break_Room_Lobby = new JLabel("Welcome to the Break Room Lobby Level ^_^");
            Break_Room_Lobby.setBounds(50, 30, 1500, 50);
            Break_Room_Lobby.setFont(CustomFontLoader.loadFont("./resources/fonts/Lato.ttf", 30));
            Break_Room_Lobby.setForeground(Color.decode("#D9D9D9"));
            panel.add(Break_Room_Lobby);
