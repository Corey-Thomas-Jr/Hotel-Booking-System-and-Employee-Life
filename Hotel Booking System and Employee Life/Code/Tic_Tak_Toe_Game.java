...
public class Tic_Tak_Toe_Game extends Music{
    public Tic_Tak_Toe_Game() {
        ...
        // JLabels
            ...
            // Tic Tak Toe
                JLabel T_T_T = new JLabel("Tic Tak Toe");
                T_T_T.setBounds(290, 70, 243, 57);
                T_T_T.setFont(CustomFontLoader.loadFont("./resources/fonts/Lato.ttf", 25));
                T_T_T.setForeground(Color.decode("#D9D9D9"));
                panel.add(T_T_T);
        ...
        // Jbuttons
            ...
            // Music
                Music m = new Music();
                // String filepath = "Teldrassil - Original Wow Music.wav";
                String filepath = "The Humans of Vanilla - Music & Ambience (1 hour, 4K, World of Warcraft Classic).wav";
                Music.AUDIO.play(filepath);
